...
import DatosCancelacion from "../screens/DatosCancelacion";
...
export const HomeStackScreen = ({ navigation }) => (
  ...
  >
    ...
    />
    <HomeStack.Screen
      name="incidenciasFormulario"
      component={incidenciasFormulario}
      options={{
...
export const LicenciasStackScreen = ({ navigation }) => (
  <LicenciasStack.Navigator screenOptions={screenOpt}>
    ...
    />
    <LicenciasStack.Screen
      name="LicenciaDetalle"
      component={LicenciaDetalle}
      options={{
        ...
        headerLeft: () => (
          <Icon.Button
            ...
            backgroundColor="#009387"
            onPress={() =>
              navigation.navigate("Licencias", { screen: "Licencias" })
            }
          />
        ),
      }}
...
export const ViajesStackScreen = ({ navigation }) => (
  <ViajesStack.Navigator screenOptions={screenOpt}>
    ...
    />
    <ViajesStack.Screen
      name="atenderViajeDetalles"
      component={atenderViajeDetalles}
      options={{
        ...
        headerLeft: () => (
          <Icon.Button
            ...
            backgroundColor="#009387"
            onPress={() =>
              navigation.navigate("Viajes", { screen: "atenderViajes" })
            }
          />
        ),
      }}
    ...
    />
    <ViajesStack.Screen
      name="rechazadosViajes"
      component={rechazadosViajes}
      options={{
      ...
      options={{
        ...
        headerLeft: () => (
          <Icon.Button
            ...
            backgroundColor="#009387"
            onPress={() =>
              navigation.navigate("Viajes", { screen: "ProximosViajes" })
            }
          />
        ),
      }}
    />
    <ViajesStack.Screen
      name="ViajeDetalleHistorial"
      component={ViajeDetalleHistorial}
      options={{
        title: "Detalles del viaje",
        headerLeft: () => (
          <Icon.Button
            ...
            backgroundColor="#009387"
            onPress={() =>
              navigation.navigate("Viajes", { screen: "historialViajes" })
            }
          />
        ),
      }}
    />
    <ViajesStack.Screen
      name="sancionesViajes"
      component={sancionesViajes}
      options={{
        title: "Sanciones",
        headerLeft: () => (
          <Icon.Button
    ...
    />
    <ViajesStack.Screen
      name="DetallesViajesEnRuta"
      component={DetallesViajesEnRuta}
      options={{
        title: "Detalles del viaje",
        headerLeft: () => (
          <Icon.Button
            ...
            backgroundColor="#009387"
            onPress={() =>
              navigation.navigate("Viajes", { screen: "iniciarViaje" })
            }
          />
        ),
      }}
    ...
    <ViajesStack.Screen
      name="DatosCancelacion"
      component={DatosCancelacion}
      options={{
...
export const CalendarioStackScreen = ({ navigation }) => (
  <CalendarioStack.Navigator screenOptions={screenOpt}>
    <CalendarioStack.Screen
      ...
      component={configurarCalendario}
      options={{
        title: "Calendario",
        headerLeft: () => (
          <Icon.Button
    ...
    />
    <CalendarioStack.Screen
      name="exitosoCalendario"
      component={exitosoCalendario}
      options={{
        ...
        headerLeft: () => (
          <Icon.Button
            ...
            backgroundColor="#009387"
            onPress={() =>
              navigation.navigate("configurarCalendario", {
                screen: "configurarCalendario",
              })
            }
          />
        ),
    ...
    />
    <CalendarioStack.Screen
      name="errorCalendario"
      component={errorCalendario}
      options={{
      ...
      options={{
        ...
        headerLeft: () => (
          <Icon.Button
            ...
            backgroundColor="#009387"
            onPress={() =>
              navigation.navigate("Estadisticas", { screen: "Estadisticas" })
            }
          />
        ),
      }}
...
export const FacturacionStackScreen = ({ navigation }) => (
  <FacturacionStack.Navigator screenOptions={screenOpt}>
      ...
      options={{
        ...
        headerLeft: () => (
          <Icon.Button
            ...
            backgroundColor="#009387"
            onPress={() =>
              navigation.navigate("Facturacion", { screen: "Facturacion" })
            }
          />
        ),
      }}
    ...
    />
    <FacturacionStack.Screen
      name="ultimasFacturas"
      component={ultimasFacturas}
      options={{
