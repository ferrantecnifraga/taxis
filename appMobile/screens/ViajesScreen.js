    ...
    <View>
      <View style={{ flexDirection: "row" }}>
        <Card containerStyle={styles.cardContainer}>
          <Icon
            ...
            onPress={() => {
              navigation.navigate("iniciarViaje");
            }}
            //   onPress={ () =>{
            //     Alert.alert(
            //       "Inicar viaje",
          ...
          />
          <Divider />
          <Text style={styles.cardText2}>Iniciar o terminar viajes</Text>
        </Card>
        <Card containerStyle={styles.cardContainer}>
          <Icon
            name="car"
            ...
            iconStyle={{ marginVertical: 10 }}
            onPress={() => {
              navigation.navigate("ProximosViajes");
            }}
          />
          <Divider />
      ...
      <View style={{ flexDirection: "row" }}>
        <Card containerStyle={styles.cardContainer}>
          ...
          />
          <Divider />
          <Text style={styles.cardText}>Viajes por aceptar</Text>
        </Card>
        <Card containerStyle={styles.cardContainer}>
          <Icon
            name="car-multiple"
      ...
      <View style={{ flexDirection: "row" }}>
        <Card containerStyle={styles.cardContainer}>
          <Icon
            ...
            iconStyle={{ marginVertical: 10 }}
            onPress={() => {
              navigation.navigate("rechazadosViajes");
            }}
          />
          <Divider />
        ...
        <Card containerStyle={styles.cardContainer}>
          <Icon
            ...
            onPress={() => {
              navigation.navigate("sancionesViajes");
            }}
          />
          <Divider />
